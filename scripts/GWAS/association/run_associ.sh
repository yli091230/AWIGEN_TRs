...
pgen_file="/expanse/protected/gymreklab-dbgap/mount/H3Africa/DS_I_Africa_project/from_ilifu/results/imputed_TRs/chr${chrom}/chr${chrom}_imputed_filtered_SNPs"
...
${PLINK2} --pfile ${pgen_file} \
  ...
  --out ${out_file}/merged_chr${chrom}_SNPs_gwas 
